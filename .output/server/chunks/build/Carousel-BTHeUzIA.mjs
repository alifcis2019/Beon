import { computed, toValue, reactive, ref, watch, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, renderSlot, useSSRContext } from 'vue';
import { H as hash } from '../nitro/nitro.mjs';
import { isPlainObject } from '@vue/shared';
import { s as fetchDefaults, t as useAsyncData, v as useRequestFetch, w as useLocale, x as useAppConfig, y as reactivePick, z as tv, a as _sfc_main$v } from './server.mjs';
...
//# sourceMappingURL=Carousel-BTHeUzIA.mjs.map
