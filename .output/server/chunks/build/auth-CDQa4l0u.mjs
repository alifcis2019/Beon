import { h as _export_sfc, a as _sfc_main$v, J as pausableFilter, x as useAppConfig, r as useMouseInElement, z as tv, K as getSlotChildrenText, _ as _sfc_main$B, A as _sfc_main$w } from './server.mjs';
import { mergeProps, withCtx, renderSlot, useSlots, ref, computed, watch, unref, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, useSSRContext } from 'vue';
      ...
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            if (__props.to) {
              _push2(ssrRenderComponent(_sfc_main$w, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: __props.target, ..._ctx.$attrs }, {
            ...
            return [
              ...
              __props.to ? (openBlock(), createBlock(_sfc_main$w, mergeProps({
                key: 1,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen flex items-center justify-center px-4" }, _attrs))}>`);
...
//# sourceMappingURL=auth-CDQa4l0u.mjs.map
