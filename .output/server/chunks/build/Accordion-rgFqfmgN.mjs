...
import { r as useAppConfig, t as tv, x as transformUI, s as reactivePick, _ as _sfc_main$B, w as get } from './server.mjs';
                            ...
                            default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ssrRenderSlot(_ctx.$slots, "leading", {
                                  ...
                                  if (item.icon) {
                                    _push5(ssrRenderComponent(_sfc_main$B, {
                                      name: item.icon,
...
//# sourceMappingURL=Accordion-rgFqfmgN.mjs.map
