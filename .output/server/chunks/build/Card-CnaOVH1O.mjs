...
import { r as useAppConfig, t as tv, v as _sfc_main$w, _ as _sfc_main$B } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.to) {
        _push(ssrRenderComponent(_sfc_main$w, mergeProps({ "aria-label": ariaLabel.value }, { to: __props.to, target: target.value, ..._ctx.$attrs }, {
...
//# sourceMappingURL=Card-CnaOVH1O.mjs.map
