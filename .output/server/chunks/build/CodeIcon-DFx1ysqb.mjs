...
import { r as useAppConfig, _ as _sfc_main$B } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (icon.value) {
        _push(ssrRenderComponent(_sfc_main$B, mergeProps({ name: icon.value }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
//# sourceMappingURL=CodeIcon-DFx1ysqb.mjs.map
